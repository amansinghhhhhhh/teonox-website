  ...
  return (
    <div className="bg-[#FFFFFF] text-[#201A17] min-h-screen pt-28 sm:pt-32 pb-24 font-['Sora',sans-serif]">
      ...
      <article className="w-[85%] max-w-4xl mx-auto pt-8 sm:pt-12">
        ...
        <div ref={proseRef} className="prose-container max-w-none">
          {post.contentHtml ? (
            <div
              className="font-inter text-[#3A312A] text-[16.5px] sm:text-[18px] leading-[1.8] space-y-6 [&_h2]:font-sora [&_h2]:text-[24px] [&_h2]:sm:text-[28px] [&_h2]:font-[800] [&_h2]:text-[#201A17] [&_h2]:mt-10 [&_h2]:mb-4 [&_h2]:pt-4 [&_h2]:border-t [&_h2]:border-[#F0DFCE] [&_h2]:scroll-mt-28 [&_h3]:font-sora [&_h3]:text-[20px] [&_h3]:font-[700] [&_h3]:text-[#201A17] [&_h3]:mt-6 [&_h3]:mb-3 [&_h3]:scroll-mt-28 [&_p]:mb-5 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:space-y-2 [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:space-y-2 [&_li]:pl-1 [&_strong]:text-[#201A17] [&_strong]:font-[700] [&_a]:text-black [&_a]:underline [&_blockquote]:border-l-4 [&_blockquote]:border-[#FF6A2B] [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:bg-[#FFF6EE] [&_blockquote]:py-2 [&_blockquote]:rounded-r"
