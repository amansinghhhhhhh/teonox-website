...
export function OnlineProgrammePage({
  ...
  return (
    <div className="online-programme-page">
      <SEO
          ...
          <div className="op-hero-grid">
            <div className="op-hero-content">
              <div className="op-hero-badge">
                <span className="op-dot" /> LIVE BATCH + 2-MONTH INTERNSHIP
              </div>
              <h1>Build Digital Marketing Skills. Master AI. Build Your <span>Career.</span></h1>
              <p className="op-hero-subtitle">TEONOX — 6-Month Business Digital Marketing + AI Programme</p>
              <div className="op-hero-highlights">
                <span className="op-hero-chip"><Clock /> 6 Months</span>
                <span className="op-hero-chip"><Video /> Live Classes</span>
                <span className="op-hero-chip"><Laptop /> Practical Projects</span>
                <span className="op-hero-chip"><Bot /> AI-Powered Learning</span>
                <span className="op-hero-chip op-hero-chip-urgent"><Users /> Batch Size: 30-35</span>
              </div>
              <div className="op-hero-ctas">
                <button type="button" className="op-btn op-btn-primary" onClick={() => setShowApplyModal(true)}>
                  <ArrowRight /> Apply Now
                </button>
                <a href="#masterclass" className="op-btn op-btn-outline"><Phone /> Book a Counselling Call</a>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Trust Strip */}
      <div className="op-trust-strip">
        <div className="op-slider-wrap">
          <div className="op-slider-viewport" ref={trustSliderRef} id="trustSlider">
            <div className="op-slider-track" style={{ transform: `translateX(-${sliderOffset}px)` }}>
              {[
                ...
                <div key={i} className="op-slider-slide">
                  <span className="op-trust-item">{item}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* Learning Experience */}
      <section className="op-learning-section section-padding" id="learning">
        <div className="op-container">
          <div style={{ textAlign: 'center' }}>
            <div className="op-section-label">LEARNING EXPERIENCE</div>
            <h2 className="op-section-title">How You'll <span style={{ color: 'var(--orange)' }}>Learn & Grow</span></h2>
          </div>
          <div className="op-learning-flow">
            {[
              ...
              <React.Fragment key={i}>
                <div className="op-learning-step">
                  <div className="op-learning-step-icon"><step.icon /></div>
                  <span>{step.label}</span>
                </div>
                {i < 4 && <span className="op-learning-arrow"><ArrowRight /></span>}
              </React.Fragment>
            ))}
          </div>
          <div className="op-learning-features">
            {[
              ...
              <div key={i} className="op-learning-feature">
                <feature.icon />
      ...
      {/* Who Is This For */}
      <section className="op-who-section section-padding" id="who">
        <div className="op-container">
          <div style={{ textAlign: 'center' }}>
            <div className="op-section-label">WHO IS THIS FOR</div>
            <h2 className="op-section-title">Built for People Who Want to <span style={{ color: 'var(--orange)' }}>Do</span>, Not Just Learn.</h2>
          </div>
          <div className="op-who-grid">
            {[
              ...
              <div key={i} className="op-who-card">
                <div className="op-who-card-icon"><card.icon /></div>
                <h4>{card.title}</h4>
                <p>{card.desc}</p>
              </div>
            ))}
      ...
      {/* Promise Section */}
      <section className="op-promise-section section-padding" id="promise">
        <div className="op-container">
          <div className="op-section-label">THE TEONOX PROMISE</div>
          <div className="op-promise-statement">
            By the end of 6 months, you won't just understand digital marketing. You'll have <span>proof that you can do it.</span>
          </div>
          <div className="op-promise-flow">
            {[
              ...
              <div key={i} className="op-promise-step">
                <div className="op-promise-step-num">{step.num}</div>
                <h4>{step.title}</h4>
                <p>{step.desc}</p>
              </div>
            ))}
      ...
      {/* Why Teonox Online */}
      <section className="op-why-section section-padding" id="why">
        <div className="op-container">
          <div style={{ textAlign: 'center' }}>
            <div className="op-section-label">WHY TEONOX</div>
            <h2 className="op-section-title">Everything You Need to <span style={{ color: 'var(--orange)' }}>Learn & Grow</span></h2>
            <p className="op-section-subtitle">A structured programme designed for serious learners who want real outcomes.</p>
          </div>
          <div className="op-why-grid">
            {[
              ...
              <div key={i} className="op-why-card">
                ...
                <div className="op-why-card-body">
                  <h3>{card.title}</h3>
                  <p>{card.desc}</p>
                </div>
              </div>
      ...
      <section className="op-curriculum-section section-padding" id="curriculum">
        <div className="op-container">
          <div style={{ textAlign: 'center' }}>
            <div className="op-section-label">SIX-MONTH LEARNING JOURNEY</div>
            <h2 className="op-section-title">Your Path from <span style={{ color: 'var(--orange)' }}>Fundamentals to Mastery</span></h2>
            <p className="op-section-subtitle">A carefully designed curriculum that takes you from foundation to career readiness.</p>
          </div>
            ...
            {[
              ...
              <div key={i} className="op-timeline-item">
                <div className="op-timeline-content">
                  <div className="op-timeline-month">{item.month}</div>
                  <div className="op-timeline-title">{item.title}</div>
                  <p className="op-timeline-desc">{item.desc}</p>
                  <div className="op-timeline-tags">
                    {item.tags.map((tag, ti) => <span key={ti} className="op-timeline-tag">{tag}</span>)}
                  </div>
                  <div className="op-timeline-output">
                    <Flag />
      ...
      {/* Portfolio Section */}
      <section className="op-portfolio-section section-padding" id="portfolio">
        <div className="op-container">
          <div style={{ textAlign: 'center' }}>
            <div className="op-section-label">BUILD YOUR PORTFOLIO</div>
            <h2 className="op-section-title">5 Projects. Real Skills. <span style={{ color: 'var(--orange)' }}>Portfolio-Ready Proof.</span></h2>
          </div>
          <div className="op-portfolio-grid">
            {[
              ...
              <div key={i} className="op-portfolio-card">
                ...
                <div className="op-portfolio-card-header"><span className="op-portfolio-num">{card.num}</span></div>
                <div className="op-portfolio-card-body">
                  <h4>{card.title}</h4>
                  <p>{card.desc}</p>
                </div>
              </div>
      ...
      {/* AI Section */}
      <section className="op-ai-section section-padding" id="ai">
        <div className="op-container">
          <div style={{ textAlign: 'center' }}>
            <div className="op-section-label">AI-FIRST LEARNING</div>
            <h2 className="op-section-title" style={{ color: 'var(--white)' }}>AI Isn't a Separate Module. It's Part of <span style={{ color: 'var(--orange)' }}>How You Learn.</span></h2>
          </div>
          ...
          <div className="op-ai-bottom">
            <span className="op-quote-icon"><Quote /></span>
            <p className="op-quote-text">Learn how marketers use AI to work faster, think better and execute smarter.</p>
            <div className="op-quote-accent"><span /><span /><span /></div>
          </div>
        </div>
      </section>

      {/* Video Section */}
      <section className="op-video-section section-padding" id="life">
        <div className="op-container">
          <div style={{ textAlign: 'center' }}>
            <div className="op-section-label">LIFE AT TEONOX</div>
            <h2 className="op-section-title">A Glimpse Into <span style={{ color: 'var(--orange)' }}>Our World</span></h2>
            <p className="op-section-subtitle">From classrooms to real-world projects — see what makes TEONOX different.</p>
          </div>
          <div className="op-slider-wrap" style={{ marginTop: 40 }}>
            <button type="button" className="op-slider-btn op-slider-btn-left" onClick={() => slideScroll('videoSlider', -1)}><ChevronLeft /></button>
            <div className="op-slider-viewport" id="videoSlider" ref={videoSliderRef}>
                    ...
                    <div className="op-reel-card">
                      <div className="op-reel-placeholder">
                        ...
                        <div className="op-reel-controls">
                          ...
                          <button type="button" className="op-reel-ctrl-btn" onClick={(e) => toggleMute(e.currentTarget)}>{muted ? <VolumeX /> : <Volume2 />}</button>
                        </div>
                        <div className="op-reel-badge"><Play /> Watch</div>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <button type="button" className="op-slider-btn op-slider-btn-right" onClick={() => slideScroll('videoSlider', 1)}><ChevronRight /></button>
          </div>
        </div>
      </section>

      {/* What You Get */}
      <section className="op-whatyouget-section section-padding" id="whatyouget">
        <div className="op-container">
          <div style={{ textAlign: 'center' }}>
            <div className="op-section-label">WHAT YOU GET</div>
            <h2 className="op-section-title">Everything Included in <span style={{ color: 'var(--orange)' }}>Your Programme</span></h2>
            <p className="op-section-subtitle">Beyond just classes — you get a complete learning ecosystem.</p>
          </div>
          <div className="op-whatyouget-grid">
            {[
              ...
              <div key={i} className="op-whatyouget-card">
                ...
                <div className="op-whatyouget-card-body">
                  <h4>{card.title}</h4>
                  <p>{card.desc}</p>
                </div>
              </div>
      ...
      {/* Career Section */}
      <section className="op-career-section section-padding" id="career">
        <div className="op-container">
          <div style={{ textAlign: 'center' }}>
            <div className="op-section-label">CAREER + BUSINESS OUTCOMES</div>
            <h2 className="op-section-title">Multiple Paths. <span style={{ color: 'var(--orange)' }}>One Strong Foundation.</span></h2>
            <p className="op-section-subtitle">Possible career directions after completing the programme.</p>
          </div>
          <div className="op-career-grid">
            <div className="op-career-col">
              <h3><Briefcase /> Career Paths</h3>
              <ul className="op-career-roles">
            ...
            <div className="op-career-col">
              <div className="op-career-independent">
                <h3><UserCheck /> For Independent Professionals</h3>
                <div className="op-career-tags">
                  <span className="op-career-tag">Freelancing</span>
                  <span className="op-career-tag">Client Acquisition</span>
                  <span className="op-career-tag">Proposals & Pitching</span>
                  <span className="op-career-tag">Personal Branding</span>
                  <span className="op-career-tag">Business Growth Fundamentals</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Faculty */}
      <section className="op-faculty-section section-padding" id="faculty">
        <div className="op-container">
          <div style={{ textAlign: 'center' }}>
            <div className="op-section-label">OUR MENTORS</div>
            <h2 className="op-section-title">Learn From People Who Actually <span style={{ color: 'var(--orange)' }}>Work in the Field.</span></h2>
            <p className="op-section-subtitle">Our mentors are industry practitioners, not just theorists.</p>
          </div>
          <div className="op-faculty-grid">
            {[
              ...
              <div key={i} className="op-faculty-card">
                ...
                <div className="op-faculty-info">
                  <h3>{fac.name}</h3>
                  <div className="op-faculty-role">{fac.role}</div>
                  <p className="op-faculty-desc">{fac.desc}</p>
                  <div className="op-faculty-expertise">
                    {fac.tags.map((tag, ti) => <span key={ti} className="op-faculty-expertise-tag">{tag}</span>)}
                  </div>
                </div>
              </div>
            ))}
      ...
      {/* FAQ */}
      <section className="op-faq-section section-padding" id="faq">
        <div className="op-container">
          <div style={{ textAlign: 'center' }}>
            <div className="op-section-label">FREQUENTLY ASKED QUESTIONS</div>
            <h2 className="op-section-title">Got Questions? <span style={{ color: 'var(--orange)' }}>We've Got Answers.</span></h2>
          </div>
      ...
      {/* Final CTA */}
      <section className="op-final-cta-section section-padding" id="final-cta">
        <div className="op-container">
          <h2 className="op-final-cta-title">Your Next Career Move Starts With What You Can <span style={{ textDecoration: 'underline', textDecorationColor: 'rgba(255,255,255,0.4)', textUnderlineOffset: 6 }}>Actually Do.</span></h2>
          <p className="op-final-cta-sub">6 Months. Live Learning. Real Projects. AI-Powered Skills.</p>
          <div className="op-final-cta-buttons">
            <button type="button" className="op-btn op-btn-white" onClick={() => setShowApplyModal(true)}><ArrowRight /> Apply Now</button>
          </div>
        </div>
      </section>

      {/* Sticky Mobile CTA */}
      <div className="op-sticky-cta">
        <button type="button" className="op-btn op-btn-primary" onClick={() => setShowApplyModal(true)}>Apply for the Next Cohort</button>
      </div>

      {/* Apply Modal */}
      {showApplyModal && (
        <div className="op-apply-modal-overlay" onClick={() => { setShowApplyModal(false); setIsSubmitted(false); }}>
          <div className="op-apply-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="op-apply-modal-grid">
              ...
              <div className="op-apply-modal-form">
                ...
                {!isSubmitted ? (
                  <form onSubmit={handleApplySubmit} className="op-apply-form">
                    ...
                    <button type="submit" className="op-btn op-btn-primary" style={{ width: '100%', padding: 14, fontSize: 15 }} disabled={isSubmitting}>
                  ...
                  <div className="op-success-state">
