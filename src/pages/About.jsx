          ...
          <div className="about-grid">
            <div className="reveal">
              ...
              <p className="section-sub" style={{ maxWidth: "100%" }}>
                TEONOX is built on 12+ years of industry experience through A2
                Digital—a digital growth company helping businesses scale
                through marketing, technology, strategy, analytics, and
                performance-driven execution.
              </p>
              <p className="section-sub">
                Over the years, we've worked with businesses, built teams, hired
                talent, and solved real growth challenges. And we kept noticing
                the same gap. Students were graduating with knowledge.
                Businesses were hiring for capability.
              </p>
              <p className="section-sub">
                Many talented individuals lacked exposure to real projects,
                modern tools, industry workflows, and the practical skills
                needed to contribute with confidence.
              </p>
              <p className="section-sub">
                We saw this challenge firsthand for years. That's why we created
                TEONOX.
              </p>
              <p className="section-sub">
                A learning ecosystem designed to bridge the gap between
                education and industry by helping students develop practical
                skills, real-world confidence, and future-ready capabilities.
              </p>
              <div className="about-quote" style={{ marginTop: "24px" }}>
                <p>
                  "Built around{" "}
                  <strong>
                    Technology, Execution, Ownership, Next-Generation
                    Opportunities, and Excellence
                  </strong>
                  , it reflects our belief that success comes not just from what
                  you know, but from what you can build, solve, and achieve."
                </p>
              </div>
              <p
                style={{
              ...
              >
                These principles shape every learning experience, project, and
                opportunity at TEONOX. Backed by the industry experience and
                insights gained through years of building brands, managing
                campaigns, growing businesses, and developing teams at A2
                Digital, TEONOX is a learning ecosystem designed to help
                students gain the skills, experience, confidence, and industry
                exposure needed to thrive in today's rapidly evolving world.
              </p>
            </div>
        ...
        <div className="container">
          <div className="about-grid" style={{ alignItems: "start" }}>
            <div className="reveal-left">
              ...
              >
                To create a generation of confident, capable professionals who
                can adapt, contribute, and thrive in the modern digital economy.
              </p>
            </div>
            <div className="reveal-right">
              ...
              <p
                ...
                style={{ maxWidth: "100%", marginTop: "20px" }}
              >
                To help students develop practical skills, industry exposure,
                and real-world confidence through experiential, industry-led
                learning.
              </p>
            </div>
          </div>
              ...
              <div className="about-stats" style={{ marginTop: "32px" }}>
                <div className="hire-why-item">
                  ...
                  <div>
                    ...
                    <p>
                      Everything we teach is rooted in the realities of modern
                      business, ensuring students develop skills that matter in
                      today's workplace.
                    </p>
                  </div>
                </div>
                <div className="hire-why-item">
                  ...
                  <div>
                    ...
                    <p>
                      We believe experience is one of the most powerful
                      teachers. Learning should go beyond theory and translate
                ...
                <div className="hire-why-item">
                  ...
                  <div>
                    ...
                    <p>
                      Technology, AI, and industries are constantly evolving. We
                      encourage learners to embrace change, think creatively,
                ...
                <div className="hire-why-item">
                  ...
                  <div>
                    ...
                    <p>
                      Growth comes from taking responsibility for outcomes,
                ...
                <div className="hire-why-item">
                  ...
                  <div>
                    ...
                    <p>
                      The most successful professionals never stop learning. We
                      foster a mindset of exploration, growth, and lifelong
                      development.
                    </p>
                  </div>
                </div>
                <div className="hire-why-item">
                  ...
                  <div>
                    ...
                    <p>
                      We value meaningful outcomes over busy work. Success is
                      measured by the value created, problems solved, and
                      progress achieved.
                    </p>
                  </div>
                </div>
      ...
      <section className="section video-gallery-section">
        <div className="container">
          <div className="reveal" style={{ marginBottom: "40px" }}>
            ...
            <p className="section-sub" style={{ maxWidth: "100%" }}>
              A glimpse into our world — real sessions, real energy, real
              growth.
            </p>
          </div>

          <div className="vc-wrap">
            <button className="vc-arrow vc-prev" id="vcPrev">
              &#10094;
            </button>

            <div className="vc-viewport" id="vcViewport">
            ...
            <button className="vc-arrow vc-next" id="vcNext">
              &#10095;
            </button>
